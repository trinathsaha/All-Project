  ...
  <section id="banner">
    <div class="bg-color">
      ...
      <header id="header">
       ...
       <button type="submit" name="unregister"><a href="unregistered.php">Unregistered</a></button>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="inner text-center">
            <h1 class="logo-name">Blood Donor Systems</h1>
            <h2>Welcome <?php echo $_SESSION['name'] ; ?> our page.</h2>
            <h2> your Blood Group : <?php echo $_SESSION['bg']; ?></h2>
            <p>Be the one donor to donate the blood</</p>
          </div>
        </div>
      </div>
    </div>
