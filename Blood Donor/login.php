        ...
        <br />
          <?php include ('errors.php')?>
            <section >
              <form action="login.php" method="POST" role="form" class="contactform">
               ...
               <div col-md-6 col-sm-6 contact-form pad-form>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control label-floating is-empty" placeholder="Username" data-rule="required" data-msg="Username is required" id="email" >
              ...
              <a href="registration.php" class="pull-right btn btn-block btn-success"> Are you new Member? </a>
